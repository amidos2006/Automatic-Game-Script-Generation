...
Initial results from GA are presented in \figref{gaWithoutElitism}. It is clear that the best chromosomes disappear after few generations so 2\% elitism is used. The drawback of using elitism that the second best chromosome is usually the same as the best one.
